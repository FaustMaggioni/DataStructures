...
import EDD.lineales.estaticas.Pila;


public class TestingPilaEstatic {
    ...
    public static void testPila() {
        ...
        System.out.println("Apila 10:\t\t\t\t\t\t" + ((p1.apilar(10))));
        ...
        System.out.println("\t\t\t\t\t--> " + p1.toString());
        System.out.println("Recupera tope espera 10 recupera: \t\t\t" + (((int) p1.obtenerTope() == 10)));
        ...
        System.out.println("Recupera tope, espera 6: \t\t\t\t" + (((int) p1.obtenerTope() == 6)));

        Pila p2 = p1.clone();
        System.out.println("Copia espera 1,2,3,4,5,6,7,8,6: \t\t\t\t--> " + p2.toString());

        while (!p1.esVacia()) {
            System.out.print("Desapila espera true: \t\t\t\t\t" + ((p1.desapilar())));
            System.out.println("\t--> " + p1.toString());
        }
        System.out.print("Se vacio la pila p1");
        System.out.println("\t\t\t\t\t\t--> " + p1.toString());
        System.out.println("Desapila en pila vacia espera false: \t\t\t" + ((p1.desapilar())));
        System.out.println("Verifica tope en pila vacia espera null: \t\t" + ((p1.obtenerTope() == null))); 
