...
public class TestGenerico {
   ...
   public static final String RESET = "\u001B[0m";
    ...
    public static void main(String args[]){
        ...
        System.out.println("Frontera de arbol vacío, espero lista vacia:"+a.frontera());
    ...
    System.out.println("Busco elemento inexistente en arbol vacio con pertenece." +
        ...
        System.out.println("Frontera de arbol solamente con raiz 10, espera: [10], da: "+a.frontera());
	...
	System.out.println("Busco el nivel de 3. Tiene que dar " + sOk+" --> "  + (((int) a.nivel(3) == 2) ? sOk : sErr));
        ...
        System.out.println("\n toString()  deberia dar: \n\n \t \t \t      10"
                ...
                + " \n \t \t \t \t \t \t \t \t \t \t \t \t  40 \t 45 \t 55"
                +"\t \t --> \t \t"+ a.toString());
        Lista frontera= a.frontera();
        //Lista frontera
        System.out.println("Frontera de arbol a espera: [7,3,12,20,22,40,45,55], da: "+frontera);
        System.out.println("\n");
        ...
        b = a.clone();
        System.out.println("Frontera de clone de a, debe dar lo mismo que en a ([7,3,12,20,22,40,45,55]), y da: "+b.frontera());
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("Frontera de b con mas elementos debe dar:[7,10,12,25,27,35,22,40,45,55] y da: "+b.frontera());
        System.out.println("\n"+AZUL+"CLON toString() \t\t\t"+b.toString()+"\n\n");
        System.out.println(VERDE+"ORIGINAL toString()\t\t\t "+a.toString()+"\n\n");
        
        System.out.println("Vacio el CLON");
        b.vaciar();
        System.out.println("Frontera de arbol clone vacia, espera lista vacia y da: "+b.frontera());
        System.out.println("Mientras que la frontera del arbol original da: "+a.frontera());
